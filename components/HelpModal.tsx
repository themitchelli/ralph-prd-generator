          ...
          <div className="prose prose-slate max-w-none">
            <ReactMarkdown
              components={{
                ...
                h2: ({ children }) => (
                  <h2 className="text-xl font-bold mb-3 mt-6 text-gray-800 border-b border-gray-200 pb-2">{children}</h2>
                ),
                h3: ({ children }) => (
                ...
                code: ({ children }) => (
                  <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm text-gray-800">{children}</code>
                ),
